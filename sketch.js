...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   bg.velocityX = -(6 + 3*score/100);
    ...
    if((touches.length > 0 || keyDown("SPACE")) && Rohan.y  >= height-20) {
      Rohan.velocityY = -10;
       touches = [];
    }
...
function spawnstones() {
  if(frameCount % 60 === 0) {
    var Stone = createSprite(width,height-95,20,30);
